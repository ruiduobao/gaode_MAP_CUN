(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("debug"), require("fs"), require("iconv-lite"), require("lodash"));
	else if(typeof define === 'function' && define.amd)
		define(["debug", "fs", "iconv-lite", "lodash"], factory);
	else if(typeof exports === 'object')
		exports["dbf.js"] = factory(require("debug"), require("fs"), require("iconv-lite"), require("lodash"));
	else
		root["dbf.js"] = factory(root["debug"], root["fs"], root["iconv-lite"], root["lodash"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE_debug__, __WEBPACK_EXTERNAL_MODULE_fs__, __WEBPACK_EXTERNAL_MODULE_iconv_lite__, __WEBPACK_EXTERNAL_MODULE_lodash__) {
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: read, header, write, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _read__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./read */ "./src/read.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "read", function() { return _read__WEBPACK_IMPORTED_MODULE_0__["read"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "header", function() { return _read__WEBPACK_IMPORTED_MODULE_0__["header"]; });

/* harmony import */ var _write__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./write */ "./src/write.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "write", function() { return _write__WEBPACK_IMPORTED_MODULE_1__["write"]; });
...
/* harmony default export */ __webpack_exports__["default"] = ({ read: _read__WEBPACK_IMPORTED_MODULE_0__["read"], header: _read__WEBPACK_IMPORTED_MODULE_0__["header"], write: _write__WEBPACK_IMPORTED_MODULE_1__["write"] });
...
/*!*********************!*\
  !*** ./src/read.js ***!
  \*********************/
/*! exports provided: header, read */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "header", function() { return parseHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "read", function() { return parse; });
...
const debug = debug__WEBPACK_IMPORTED_MODULE_2___default()('dbf-js');
...
function parseHeader(filename, encoding = "gb18030") {
    ...
    let buffer = Object(fs__WEBPACK_IMPORTED_MODULE_0__["readFileSync"])(filename);
...
function bufferToString(buffer) {
    return Object(iconv_lite__WEBPACK_IMPORTED_MODULE_1__["decode"])(buffer, Config.encoding).replace(/[\u0000]+$/, '').trim();
}
...
function parseValue(field, buffer) {
    let originValue = Object(iconv_lite__WEBPACK_IMPORTED_MODULE_1__["decode"])(buffer, Config.encoding).trim();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "write", function() { return write; });
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fs */ "fs");
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var iconv_lite__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! iconv-lite */ "iconv-lite");
/* harmony import */ var iconv_lite__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(iconv_lite__WEBPACK_IMPORTED_MODULE_1__);
...
function write(fields, data, filename, encoding="gb18030") {
    ...
    if(!filename)
        ...
        if(Object(fs__WEBPACK_IMPORTED_MODULE_0__["existsSync"])(filename)) Object(fs__WEBPACK_IMPORTED_MODULE_0__["unlinkSync"])(filename);
        Object(fs__WEBPACK_IMPORTED_MODULE_0__["writeFileSync"])(filename,  Buffer.from(view.buffer));
    }
}
...
function writeField(view, offset, string) {
    let buf = Object(iconv_lite__WEBPACK_IMPORTED_MODULE_1__["encode"])(string, Config.encoding);
...
function writeString(view, offset, string, length) {
    let strBuf = Object(iconv_lite__WEBPACK_IMPORTED_MODULE_1__["encode"])(string, Config.encoding);
...
function writeNumber(view, offset, value, precision, length) {
    ...
    let valBuf = Object(iconv_lite__WEBPACK_IMPORTED_MODULE_1__["encode"])(value, "ASCII");
...
function writeDate(view, offset, value) {
    let date = '19000001';
    if(Object(lodash__WEBPACK_IMPORTED_MODULE_3__["isDate"])(value)) {
        date = `${value.getFullYear() * 10000 + value.getMonth() * 100 + 100 + value.getDate()}`;
    } else if(Object(lodash__WEBPACK_IMPORTED_MODULE_3__["isString"])(value)){
...
module.exports = __WEBPACK_EXTERNAL_MODULE_iconv_lite__;
